  ...
  return (
    <div>
      ...
      >
        ...
        {/* Content */}
<div className="relative z-20 w-full max-w-7xl mx-auto h-full">
  ...
  <motion.div
    ...
    viewport={{ once: true }}
    className="absolute bottom-5 left-6 md:left-20 max-w-xl text-white"
  >
  ...
  {/* SPECIALIZE CARD (BOTTOM RIGHT) */}
  <motion.div
    initial={{ opacity: 0, x: 80, filter: "blur(10px)" }}
    whileInView={{ opacity: 1, x: 0, filter: "blur(0px)" }}
    transition={{ duration: 0.9, ease: "easeOut", delay: 0.2 }}
    viewport={{ once: true }}
    className="absolute top-5 right-6 md:right-20 w-[320px] md:w-[420px] bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 sm:p-8 text-white"
  >
    ...
    <ul className="space-y-3 text-base sm:text-lg">
      ...
      >
        ...
        <div className="flex flex-col md:flex-row justify-center gap-6">
          <a
            href="https://mail.google.com/mail/?view=cm&fs=1&to=emadahamed2927@gmail.com&su=Video%20Editing%20Project&body=Hi%20Emad%2C%20I%20saw%20your%20portfolio."
            target="_blank"
